...
<h1>FAITH CANON</h1>
<p>Request your Prayers here any time any moment, anywhere...</p>
</style>
...
<h2>GET PRAYER NOW</h2>

<button></button>
<a href="#" class="button">SMS</a>
<button class="button">CALL</button>
<input type="button" class="button" value="VIDEO">
...
$user = "99HhlTj"; // Change ********, and put your Proovl user ID
$token = "1x6gnjPM4hWPwfhvajPqZ1VhKqrQkTGK"; // Change ********, and put your Proovl authentication token
$from = "+254722215810"; // Change ********, phone number under your Proovl account
